...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div role="form" runat="server" id="form" class="form-horizontal">
        <fieldset style="max-width: 500px; margin: 10px auto">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="MobileNumberTextBox" runat="server" placeholder="Mobile Number" type="tel" CssClass="form-control"></asp:TextBox>
    ...
    <div id="reply" runat="server" visible="false">
        <div style="max-width: 500px; margin: auto;">
            ...
            <label>Date/Time :&nbsp;</label><asp:Label ID="DateTimeLabel" runat="server" Text="DateLabel"></asp:Label><br />
            <br />
